...
public class ReportHandlerIntegrationTest {
    ...
    @Test public void testPostSuccess() throws Exception {
        mHandler.handleReport(TestsUtils.newReport(SdkEvent.POST_SYNC, event1));
        mHandler.handleReport(TestsUtils.newReport(SdkEvent.POST_SYNC, event2));
    ...
    @Test public void testTrackEvent() {
        ...
        for (int i = 1; i <= 10; i++) {
            mHandler.handleReport(TestsUtils.newReport(SdkEvent.ENQUEUE, event1));
    ...
    @Test public void testTrackTriggerFlush() throws Exception {
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            mHandler.handleReport(TestsUtils.newReport(SdkEvent.ENQUEUE, event));
        }

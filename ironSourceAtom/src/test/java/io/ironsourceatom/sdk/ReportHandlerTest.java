...
public class ReportHandlerTest {
    ...
    @Test public void trackOnly() throws Exception {
        ...
        Intent intent = TestsUtils.newReport(SdkEvent.ENQUEUE, reportMap);
    ...
    @Test public void postSuccess() throws Exception {
        ...
        Intent intent = TestsUtils.newReport(SdkEvent.POST_SYNC, reportMap);
    ...
    @Test public void flushNothing() {
        Intent intent = TestsUtils.newReport(SdkEvent.FLUSH_QUEUE, new HashMap<String, String>());
        assertEquals(mHandler.handleReport(intent), HandleStatus.HANDLED);

...
class IBConfig {
    ...
    protected static String ironsourceatom_TRACKER_TABLE = "ironsourceatom_sdk";
    protected static String ironsourceatom_TRACKER_TOKEN = "5ALP9S8DUSpnL3hm4N8BewFnzZqzKt";

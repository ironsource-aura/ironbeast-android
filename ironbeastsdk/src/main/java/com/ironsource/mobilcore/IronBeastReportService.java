...
public class IronBeastReportService extends Service {
	...
	public void onCreate() {
		Logger.log("MobileCoreReport service onCreate() | called", Logger.SDK_DEBUG);
		try {
	...
	public void onDestroy() {
		...
		Logger.log("MobileCoreReport service onDestroy() | called", Logger.SDK_DEBUG);
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		Logger.log("MobileCoreReport service , onStartCommand() | startId:" + startId, Logger.SDK_DEBUG);
